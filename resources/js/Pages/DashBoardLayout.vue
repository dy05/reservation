                  ...
                  <div class="p-4 max-w-xl mx-auto relative absolute left-0 right-0 overflow-hidden mt-24">
                    ...
                    <div class="shadow w-full rounded-lg bg-white overflow-hidden w-full block p-8">
                      ...
                      <div class="inline-block w-64 mb-4">
                        ...
                        <div class="relative">
                          <select v-on:change="event_theme = $event.target.value;" v-model="event_theme" class="block appearance-none w-full bg-gray-200 border-2 border-gray-200 hover:border-gray-500 px-4 py-2 pr-8 rounded-lg leading-tight focus:outline-none focus:bg-white focus:border-blue-500 text-gray-700">
